...
Before doing anything else, confirm that the debt is accurate. Medical billing errors are extremely common — duplicate charges, services not rendered, and [upcoded procedures](/glossary/what-is-upcoding) occur at high rates. Check the original [EOB](/glossary/what-is-an-eob) from your insurer and verify that the [patient responsibility](/glossary/what-is-patient-responsibility) the provider collected matches what your insurer calculated.
...
When a bill goes to collections, the clock is ticking on your right to dispute it. The **$29 Complete Dispute Kit** includes a debt validation letter template, a medical billing error checklist, and a guide for challenging collection activity on disputed bills — everything you need to respond within the 30-day FDCPA window with confidence. [Get the Complete Dispute Kit](/dispute-kit)
